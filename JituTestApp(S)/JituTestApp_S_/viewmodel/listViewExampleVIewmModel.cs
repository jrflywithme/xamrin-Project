...
{
    public class listViewExampleVIewmModel : ContentPage
    {
        public static ObservableCollection<string> items { get; set; }
        public listViewExampleVIewmModel()
        {
    ...
    public class textViewCell : ViewCell
    {
        ...
        {
            var item = (MenuItem)sender;
            listViewExampleVIewmModel.items.Remove(item.CommandParameter.ToString());
        }
    }
}
